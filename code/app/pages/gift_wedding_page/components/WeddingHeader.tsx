...
export const WeddingHeader = ({ stats }: WeddingHeaderProps) => (
  <div className="relative overflow-hidden bg-gradient-to-br from-stone-100 via-neutral-100 to-stone-50">
    ...
    <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-20 text-center">
      {/* Logo e Título - Layout otimizado para mobile */}
      ...
      {/* Seção de Progresso - Otimizada para mobile */}
